...
public class TitleBar extends AnchorPane {
	...
	public Button minimizeButton() {
		if(b_minimize == null) {
			...
			ImageView i = new ImageView(OiDuarkApp.getInstance().getResourceLoader().loadIcon("minimize_button_100px.png"));
			i.setFitHeight(18);
			i.setFitWidth(18);
	...
	public Button resizeButton() {
		if(b_resize == null) {
			b_resize = new Button();
			ImageView i = new ImageView(OiDuarkApp.getInstance().getResourceLoader().loadIcon("maximize_button_64px.png"));
			i.setFitHeight(18);
			i.setFitWidth(18);
	...
	public Button closeButton() {
		if(b_close == null) {
			b_close = new Button();
			ImageView i = new ImageView(OiDuarkApp.getInstance().getResourceLoader().loadIcon("close_window_100px.png"));
			i.setFitHeight(18);
			i.setFitWidth(18);
